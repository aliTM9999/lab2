...
/* Private user code ---------------------------------------------------------*/
/* USER CODE BEGIN 0 */
#define SINE_TABLE_SIZE 700//100 for timer implementation  -- Mulitplying by 2 drops pitch by one octave
#define SINE_TABLE_SIZE2 800
#define SINE_TABLE_SIZE3 900
